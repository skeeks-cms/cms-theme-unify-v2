            ...
            <div class="sx-content-section" id="location">
                <div class="sx-container container">
                    ...
                    <div class="row sx-slider-block">
                        <div class="col-12 col-sm-6 <?php echo $counter % 2 == 0 ? "order-sm-1" : "order-sm-2"; ?>  my-auto">
                        ...
                        <div class="col-12 col-sm-6 <?php echo $counter % 2 == 0 ? "order-sm-2" : "order-sm-1"; ?> my-auto">
                            <?php
