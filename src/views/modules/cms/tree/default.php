...
<? if ($this->theme->is_image_body_begin) : ?>
    <section class="g-bg-cover g-bg-size-cover g-bg-black-opacity-0_5--after sx-body-begin-image-wrapper g-flex-centered" data-bg-img-src="<?= ($model->image && $model->image->image_width >= 1920) ? \Yii::$app->imaging->thumbnailUrlOnRequest($model->image->src,
